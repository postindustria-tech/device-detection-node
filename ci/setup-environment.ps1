...
$packageJSON = @"
{
  ...
  "scripts": {
     ...
     "integration-test": "jest --ci --reporters=jest-junit --reporters=default --coverage --coverageReporters=cobertura --testPathIgnorePatterns '(deviceDetectionCloud.test.js)'",
