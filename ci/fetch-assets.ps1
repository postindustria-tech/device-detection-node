...
Expand-Archive -Path $assets/51Degrees-Tac.zip -DestinationPath $RepoName/fiftyone.devicedetection.cloud/tests/
Rename-Item -Path $RepoName/fiftyone.devicedetection.cloud/tests/51Degrees-Tac-All.csv -NewName 51Degrees.csv